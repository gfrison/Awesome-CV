...
%---------------------------------------------------------
  \cventry
    ...
    {Jan. 2017 - present} % Date(s)
    {
      ...
      more efficient and usable than the traditional web. Users may search and purchase items, 
      asking for informations and all other functionalities available in Hybris Commerce.
      ...
      but also the investigation and the implementation of the state of the art components for natural language processing.
